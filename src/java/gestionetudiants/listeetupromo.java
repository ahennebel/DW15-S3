 ...
 */
public class listeetupromo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet listeetupromo</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            int numPromo = (Integer.parseInt(request.getParameter("choixpromo")));
            Promotion bonnePromo = listPromtions.get(numPromo-1);
            out.println("Liste des etudiants : \n" + bonnePromo.getListEtud()); 
            out.println("<br><a href=\"index.html\">Retour au menu</a>");
            out.println("<br><a href=\"listingetudiantspromo\">Afficher une autre promotion</a>");
            out.println("</body>");
            out.println("</html>");
        }
    }
